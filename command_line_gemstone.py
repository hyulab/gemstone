...
# Description: This script is to start the whole pipeline with parameters selected by the user.
#              For test purposes, run this script locally taking in one argument of a parameter file (provided as test_parameter.py).
...
c = imp.load_source('cache', args.para).cache
